...
**Account:** `431445718054` | **Region:** `us-east-1` | **Parser:** Ollama (local, no Z.AI key)
...
# Expected: "Arn": "arn:aws:iam::431445718054:user/doc-parser-admin"
```
...
export AWS_ACCOUNT_ID=431445718054
...
| `ECR_REGISTRY` | `431445718054.dkr.ecr.us-east-1.amazonaws.com` |
...
aws iam detach-user-policy \
  --user-name doc-parser-cicd \
  --policy-arn arn:aws:iam::431445718054:policy/doc-parser-cicd-policy 2>/dev/null || true
